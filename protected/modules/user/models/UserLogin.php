		...
		if(!$this->hasErrors())  // we only want to authenticate when no input errors
		{
			...
			switch($identity->errorCode)
			{
				...
				case UserIdentity::ERROR_EMAIL_INVALID:
                    ...
                    Yii::app()->user->setFlash('success', "Email is incorrect.");
					break;
				case UserIdentity::ERROR_USERNAME_INVALID:
					$this->addError("username",UserModule::t("Username is incorrect."));
                    Yii::app()->user->setFlash('success', "Username is incorrect.");
					break;
				case UserIdentity::ERROR_STATUS_NOTACTIV:
					$this->addError("status",UserModule::t("You account is not activated."));
                    Yii::app()->user->setFlash('success', "Your Account has not been activated");
					break;
				case UserIdentity::ERROR_STATUS_BAN:
					$this->addError("status",UserModule::t("You account is blocked."));
                    Yii::app()->user->setFlash('success', "Account Blocked");
					break;
				case UserIdentity::ERROR_PASSWORD_INVALID:
					$this->addError("password",UserModule::t("Password is incorrect."));
                    Yii::app()->user->setFlash('success', "Password is incorrect.");
					break;
			}
		}
	}
