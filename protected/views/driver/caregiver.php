<?php $id=$data['driver_id']; $d1=User::model()->findbyPk($id); $drivername= $d1->FullName;
$pid=$data['patient_id']; $d2=User::model()->findbyPk($pid); $patientname= $d2->FullName;?>
...
<p>&nbsp;</p>
<p>Dated:<?php echo $data['Timein'];?></p>
<p>&nbsp;</p>
