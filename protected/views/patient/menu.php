...
?>
 <h2>Todays
    ...
    Select
    the items (by clicking),
and we'll bring them to your residence,
    so you may touch, smell,
    and in some cases taste for yourself.</h4> <?php } ?>
<div
    class="row">

        <div class="col-lg-12 col-xs-12"  id="selectable">


            <?php $this->renderPartial('_mobileproductview',
                array('model'=>$model)
