...
<div class="col-sm-3 col-md-3 box" id="<?php echo $data->strain; ?>">
    <div class="thumbnail">
        <h4 class="text-center"><span class="label label-info"><?php echo CHtml::encode($data->type); ?></span></h4>
        <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/inventory/<?php echo $data->mainImage; ?>"
             class="magniflier img-responsive">
        <div class="caption">
