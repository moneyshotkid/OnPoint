...
class EAjaxUpload extends CWidget
{
	...
	public $css=null;
		...
		{
		      throw new CException('Upload: param "action" cannot be empty.');
                }

		if(empty($this->config['allowedExtensions']))
		{
		      throw new CException('Upload: param "allowedExtensions" cannot be empty.');
                }

		if(empty($this->config['sizeLimit']))
		{
		      throw new CException('Upload: param "sizeLimit" cannot be empty.');
                }
