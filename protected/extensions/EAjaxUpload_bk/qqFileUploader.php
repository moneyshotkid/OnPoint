 ...
 ini_set('display_errors','off');
             display_errors(false);
						...
						asido::driver('gd');
							...
							$img = asido::image($uploadDirectory.''.$filename , $uploadDirectory.''.$source);
							asido::frame($img, 120,90, Asido::color(255, 255, 255));
							$img->save( ASIDO_OVERWRITE_ENABLED );
   



             return array('success'=>true,'filename'=>$filename,'thumbname'=>$source);
        } else {
