...
class JSimpleFilter extends CInputWidget
{
	...
	public function registerClientScript()
	{
        ...
        if ($this->useQuicksilver)
            $cs->registerScriptFile($this->baseUrl.'/js/jquery.quicksilver.js');
        $cs->registerScriptFile($this->baseUrl.'/js/jquery.simpleFilter.min.js');
	...
	public function registerCssFile($url=null)
	{
		$cs=Yii::app()->getClientScript();
		if($url===null)
            $url = $this->baseUrl.'/css/jquery.simpleFilter.css';
