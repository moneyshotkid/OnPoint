...
f.display=h.style.display;f.position=h.style.position;f.parent&&f.parent.removeChild(h)}f=a.baseZ;var k=b.browser.msie||a.forceIframe?b('<iframe class="blockUI" style="z-index:'+f++ +';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="'+a.iframeSrc+'"></iframe>'):b('<div class="blockUI" style="display:none"></div>');h=a.theme?b('<div class="blockUI blockOverlay ui-widget-overlay" style="z-index:'+f++ +';display:none"></div>'):b('<div class="blockUI blockOverlay" style="z-index:'+
f++ +';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');f=b(a.theme&&e?'<div class="blockUI '+a.blockMsgClass+' blockPage ui-dialog ui-widget ui-corner-all" style="z-index:'+f+';display:none;position:fixed"><div class="ui-widget-header ui-dialog-titlebar ui-corner-all blockTitle">'+(a.title||"&nbsp;")+'</div><div class="ui-widget-content ui-dialog-content"></div></div>':a.theme?'<div class="blockUI '+a.blockMsgClass+' blockElement ui-dialog ui-widget ui-corner-all" style="z-index:'+
f+';display:none;position:absolute"><div class="ui-widget-header ui-dialog-titlebar ui-corner-all blockTitle">'+(a.title||"&nbsp;")+'</div><div class="ui-widget-content ui-dialog-content"></div></div>':e?'<div class="blockUI '+a.blockMsgClass+' blockPage" style="z-index:'+f+';display:none;position:fixed"></div>':'<div class="blockUI '+a.blockMsgClass+' blockElement" style="z-index:'+f+';display:none;position:absolute"></div>');c&&(a.theme?(f.css(i),f.addClass("ui-widget-content")):f.css(g));!a.theme&&
(!a.applyPlatformOpacityRules||!b.browser.mozilla||!/Linux/.test(navigator.platform))&&h.css(a.overlayCSS);h.css("position",e?"fixed":"absolute");(b.browser.msie||a.forceIframe)&&k.css("opacity",0);g=[k,h,f];var o=e?b("body"):b(d);b.each(g,function(){this.appendTo(o)});a.theme&&a.draggable&&b.fn.draggable&&f.draggable({handle:".ui-dialog-titlebar",cancel:"li"});g=v&&(!b.boxModel||b("object,embed",e?null:d).length>0);if(r||g){e&&a.allowBodyStretch&&b.boxModel&&b("html,body").css("height","100%");if((r||
!b.boxModel)&&!e){g=parseInt(b.css(d,"borderTopWidth"))||0;i=parseInt(b.css(d,"borderLeftWidth"))||0;var m=g?"(0 - "+g+")":0,n=i?"(0 - "+i+")":0}b.each([k,h,f],function(b,d){var c=d[0].style;c.position="absolute";if(b<2)e?c.setExpression("height","Math.max(document.body.scrollHeight, document.body.offsetHeight) - (jQuery.boxModel?0:"+a.quirksmodeOffsetHack+') + "px"'):c.setExpression("height",'this.parentNode.offsetHeight + "px"'),e?c.setExpression("width",'jQuery.boxModel && document.documentElement.clientWidth || document.body.clientWidth + "px"'):
...
20)):w(f[0],a.centerX,a.centerY);a.timeout&&(c=setTimeout(function(){e?b.unblockUI(a):b(d).unblock(a)},a.timeout),b(d).data("blockUI.timeout",c))}function p(d,a){var e=d==window,c=b(d),g=c.data("blockUI.history"),i=c.data("blockUI.timeout");i&&(clearTimeout(i),c.removeData("blockUI.timeout"));a=b.extend({},b.blockUI.defaults,a||{});s(0,d,a);var h;h=e?b("body").children().filter(".blockUI").add("body > .blockUI"):b(".blockUI",d);e&&(j=l=null);a.fadeOut?(h.fadeOut(a.fadeOut),setTimeout(function(){n(h,
g,a,d)},a.fadeOut)):n(h,g,a,d)}function n(d,a,e,c){d.each(function(){this.parentNode&&this.parentNode.removeChild(this)});if(a&&a.el)a.el.style.display=a.display,a.el.style.position=a.position,a.parent&&a.parent.appendChild(a.el),b(c).removeData("blockUI.history");if(typeof e.onUnblock=="function")e.onUnblock(c,e)}function s(d,a,e){var c=a==window;a=b(a);if(d||!(c&&!j||!c&&!a.data("blockUI.isBlocked")))c||a.data("blockUI.isBlocked",d),e.bindEvents&&(!d||e.showOverlay)&&(d?b(document).bind("mousedown mouseup keydown keypress",
e,u):b(document).unbind("mousedown mouseup keydown keypress",u))}function u(d){if(d.keyCode&&d.keyCode==9&&j&&d.data.constrainTabKey){var a=l,e=d.shiftKey&&d.target===a[0];if(!d.shiftKey&&d.target===a[a.length-1]||e)return setTimeout(function(){t(e)},10),!1}a=d.data;if(b(d.target).parents("div."+a.blockMsgClass).length>0)return!0;return b(d.target).parents().children().filter("div.blockUI").length==0}function t(b){l&&(b=l[b===!0?l.length-1:0])&&b.focus()}function w(d,a,e){var c=d.parentNode,g=d.style,
i=(c.offsetWidth-d.offsetWidth)/2-(parseInt(b.css(c,"borderLeftWidth"))||0);d=(c.offsetHeight-d.offsetHeight)/2-(parseInt(b.css(c,"borderTopWidth"))||0);if(a)g.left=i>0?i+"px":"0";if(e)g.top=d>0?d+"px":"0"}if(/1\.(0|1|2)\.(0|1|2)/.test(b.fn.jquery)||/^1.1/.test(b.fn.jquery))alert("blockUI requires jQuery v1.2.3 or later!  You are using v"+b.fn.jquery);else{b.fn._fadeIn=b.fn.fadeIn;var q=function(){},o=document.documentMode||0,v=b.browser.msie&&(b.browser.version<8&&!o||o<8),r=b.browser.msie&&/MSIE 6.0/.test(navigator.userAgent)&&
!o;b.blockUI=function(b){m(window,b)};b.unblockUI=function(b){p(window,b)};b.growlUI=function(d,a,e,c){var g=b('<div class="growlUI"></div>');d&&g.append("<h1>"+d+"</h1>");a&&g.append("<h2>"+a+"</h2>");e==void 0&&(e=3E3);b.blockUI({message:g,fadeIn:700,fadeOut:1E3,centerY:!1,timeout:e,showOverlay:!1,onUnblock:c,css:b.blockUI.defaults.growlCSS})};b.fn.block=function(d){return this.unblock({fadeOut:0}).each(function(){if(b.css(this,"position")=="static")this.style.position="relative";if(b.browser.msie)this.style.zoom=
1;m(this,d)})};b.fn.unblock=function(b){return this.each(function(){p(this,b)})};b.blockUI.version=2.38;b.blockUI.defaults={message:"<h1>Please wait...</h1>",title:null,draggable:!0,theme:!1,css:{padding:0,margin:0,width:"30%",top:"40%",left:"35%",textAlign:"center",color:"#000",border:"3px solid #aaa",backgroundColor:"#fff",cursor:"wait"},themedCSS:{width:"30%",top:"40%",left:"35%"},overlayCSS:{backgroundColor:"#ff0",opacity:0.2,cursor:"wait"},growlCSS:{width:"350px",top:"10px",left:"",right:"10px",
